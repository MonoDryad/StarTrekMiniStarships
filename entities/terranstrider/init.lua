...
function ENT:PrimaryAttack()
	...
	local fP = { Vector(38,0,2),Vector(61,-56,26),Vector(104,0,26),Vector(61,56,0),Vector(61,-56,0),Vector(104,0,0) }
...
function ENT:SecondaryAttack()
	...
	local bullet = {}
	bullet.Num 	= 5
	bullet.Src 	= self:LocalToWorld( Vector(38,0,2) )
	bullet.Dir 	= (TracePlane.HitPos - bullet.Src):GetNormalized()
	bullet.Spread 	= Vector( 0.05,  0.05, 0.05 )
	bullet.Tracer	= 1
