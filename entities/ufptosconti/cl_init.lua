...
function ENT:Draw()
	...
	render.DrawSprite( self:LocalToWorld( Vector(58,-41.8,8.05) ), 12, 12, Color( 255, 255, 255, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(57.9,-41,13.5) ), 12, 12, Color( 0, 255, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(57.9,41,13.5) ), 12, 12, Color( 255, 0, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(58,41.8,8.05) ), 12, 12, Color( 255, 255, 255, 255) )

	render.DrawSprite( self:LocalToWorld( Vector(101.5,3,10) ), Size, Size, Color( 255, 255, 255, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(101.5,0,10) ), Size, Size, Color( 255, 255, 255, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(101.5,-3,10) ), Size, Size, Color( 255, 255, 255, 255) )
end
