...
function ENT:PrimaryAttack()
	...
	local fP = { Vector(71,16,11),Vector(71,-16,11),Vector(184,0,51),Vector(18,56,46),Vector(61,-56,-246),Vector(104,0,290) }
...
function ENT:SecondaryAttack()
	...
	local bullet = {}
	bullet.Num 	= 1
	bullet.Src 	= self:LocalToWorld( Vector(72.24,0,0) )
	bullet.Dir 	= (TracePlane.HitPos - bullet.Src):GetNormalized()
	bullet.Spread 	= Vector( 0,  0, 0 )
	bullet.Tracer	= 1
	bullet.TracerName	= "beam_effect_green_tracer"
