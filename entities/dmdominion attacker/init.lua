...
function ENT:PrimaryAttack()
	...
	local fP = { Vector(25.5,0,-3),Vector(35, 0,0),Vector(35,0,0) }
	...
	bullet.Spread 	= Vector( 0.01,  0.004, 0.03 )
	bullet.Tracer	= 1
	bullet.TracerName	= "beam_effect_purple_tracer_driad"
	bullet.Force	= 0
	bullet.HullSize 	= 0
	bullet.Damage	= 5
...
function ENT:SecondaryAttack()
	...
	local bullet = {}
	bullet.Num 	= 4
	bullet.Src 	= self:LocalToWorld( Vector(25.5,0,-3) )
	bullet.Dir 	= (TracePlane.HitPos - bullet.Src):GetNormalized()
