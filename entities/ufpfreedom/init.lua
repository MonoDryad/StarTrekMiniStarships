...
function ENT:PrimaryAttack()
	...
	local fP = { Vector(20,17,0),Vector(20,-17,0),Vector(104,0,21),Vector(61,36,6),Vector(61,-36,6),Vector(104,0,6) } 
...
function ENT:SecondaryAttack()
	...
	local bullet = {}
	bullet.Num 	= 3
	bullet.Src 	= self:LocalToWorld( Vector(30,0,-5) )
	bullet.Dir 	= (TracePlane.HitPos - bullet.Src):GetNormalized()
	bullet.Spread 	= Vector( 0.05,  0.05, 0.005 )
	bullet.Tracer	= 1
